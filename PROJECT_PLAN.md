...
- 跑配置检查、contract probe、本地 smoke、OLED smoke。
- 记录联调问题和最终可运行命令。
...
当前项目已经完成本地基础闭环、配置检查、Agent 响应 envelope 解析、语音按钮 toggle、Agent contract 错误处理等基础能力。下一步重点是继续完善 OLED 表情固件和真实 Hermes / Gran、STT、TTS 服务联调。
